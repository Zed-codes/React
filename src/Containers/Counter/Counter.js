...
import NotCounterControl from "../../Components/CounterControl/NotCounterControl";
  ...
  render() {
    return (
      <div>
        ...
        <NotCounterControl
          label="Multiply by 2"
          clicked={this.props.onMultiplyCounter}
        />
        <hr />
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onMultiplyCounter: () => dispatch({type: actionTypes.MULTIPLY}) 
  };
};
